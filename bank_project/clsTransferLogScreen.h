...
private:
    ...
    static void PrintTransferLogRecordLine(clsBankClient::stTrnsferLogRecord TransferLogRecord)
    {
        ...
        cout << "| " << setw(8) << left << TransferLogRecord.SourceClient;
        cout << "| " << setw(8) << left << TransferLogRecord.DestinationClient;
        cout << "| " << setw(8) << left << TransferLogRecord.Amount;
        cout << "| " << setw(10) << left << TransferLogRecord.SourceClientBalance;
        cout << "| " << setw(10) << left << TransferLogRecord.des_ClientBalance;
